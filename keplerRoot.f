	...
	double precision root, oldroot, lint, rint, tol, eps, manom, Y(32), E(9)
	double precision itersol(32,9), bissol(32,9), newsol(32,9), secsol(32,9)
	external new, iter, sec, bis
	integer i, j, k, n, dec

	tol = 5.d-15				! We want roots accurate to 14 decimal places

	DO k = 1, 32
		Y(k)=dble(k-1)/10.0d0	! Y is an an array of mean anomaly values 0.0, 0.1, É, 3.1
	END DO

	E(1)=0.0d0				! E is an array of eccentricity values
	E(2)=0.1d0
	E(3)=0.2d0
	E(4)=0.4d0
	E(5)=0.8d0
	...
	PRINT *,'Use Aitken acceleration? (0 = yes, 1 = no)'
	READ *,dec

	PRINT *,' '
	PRINT *,'DISPLAY FORMAT:'
	PRINT *,' '
	PRINT *,'EPSILON = value, Y = value'
